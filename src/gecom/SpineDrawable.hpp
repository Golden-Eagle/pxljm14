#ifndef GECOM_SPINEDRAWABLE_HEADER
#define GECOM_SPINEDRAWABLE_HEADER
...
namespace gecom {
    ...
    public:
//        virtual void callback(spAnimationState* state, int trackIndex, spEventType type, spEvent* event, int loopCount) const;
